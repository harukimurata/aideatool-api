...
import { MatchTableResponseEntity } from "../interfaces/enttiry/matchTable";
...
import { MatchTableOrderUpdate } from "../interfaces/matchTableOrder";
import { MatchTableResultUpdate } from "../interfaces/matchTableResult";
import { ConflictError } from "../interfaces/my-error";
import * as MatchTableModel from "../models/matchTableModel";
import * as MatchTableOrderModel from "../models/matchTableOrderModel";
import * as MatchTablePlayerModel from "../models/matchTablePlayerModel";
import * as MatchTableResultModel from "../models/matchTableResultModel";
/**
 * 大会情報作成
 * @param data
 */
