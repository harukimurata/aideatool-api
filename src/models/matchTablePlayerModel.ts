...
import { MatchTablePlayerEntity } from "../interfaces/enttiry/matchTablePlayer";
import { MatchTablePlayerCreate } from "../interfaces/matchTablePlayer";
...
export async function create(
  ...
  const result: [OkPacket, any] = await dbConnection.query(
